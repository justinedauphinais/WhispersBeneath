...
public class DynamicInventoryDisplay : InventoryDisplay
{
    ...
    public void RefreshDynamicInventory(InventorySystem invToDisplay, int offset, GameObject gameObject = null)
    {
        ClearSlots();
        inventorySystem = invToDisplay;
        if (inventorySystem != null) inventorySystem.OnInventorySlotChanged += UpdateSlot;
        if (gameObject) eventReceiver = gameObject.GetComponent<GraveDecorationManagement>();
